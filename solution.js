...
//    Declare a variable named str and assign a string as its value. Make sure the string is at least 6 characters long. Print the variable to the console.
...
console.log(str[1], str[5]);
  ...
  //  Declare a variable called firstName and assign a string as its value.
firstName = "Rami";
...
console.log(programminLanguage[0], programmingLanguage[1]);
